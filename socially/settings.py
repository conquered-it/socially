...
SECRET_KEY = "django-insecure-l^mw%6@j4#i#$_^ad(ig&vwdm43hfz%w*uf5_sfhcqrocl99a!"
...
DB_USER = os.getenv("DB_USER", "default_val")
DB_PASSWORD = os.getenv("DB_PASSWORD", "default_val")
DB_HOST = os.getenv("DB_HOST", "default_val")
